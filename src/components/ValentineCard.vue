<template>
  <div class="happy-valentines">
    <div class="valentines-day-heart-card">
      <div class="heart">500</div>
      <div class="number-of-heart"><span> {{ daysNumberLove() }} </span></div>
    </div>
...
export default {
  ...
  methods: {
    daysNumberLove: function () {
      const date1 = new Date("1/30/2023");
...
.text:hover:before {
  content: "Hãy nhớ là đừng ăn nhiều đồ ngọt vì em đã quá đỗi ngọt ngào.";
  font-size: 25px;
}
